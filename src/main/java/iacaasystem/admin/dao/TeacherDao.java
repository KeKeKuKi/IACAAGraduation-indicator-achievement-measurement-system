...
public interface TeacherDao {
    @Select("select teacher_table_id as teacherId,teacher_password as passWord,teacher_job_number as teacherNumber,teacher_name as teacherName," +
            ...
            "teacher_edit_state as editState from teacher order by teacher_table_id desc")
    ...
    @Select("select teacher_table_id as teacherId,teacher_job_number as teacherNumber,teacher_name as teacherName,teacher_sex as teacherSex,teacher_age as teacherAge," +
            "teacher_phonenumber as teacherPhonenumber,teacher_online_state as onlineState,teacher_edit_state as editState from teacher where teacher_job_number = #{number}")
    ...
    @Update("insert into teacher (teacher_password,teacher_job_number,teacher_name,teacher_sex,teacher_age,teacher_phonenumber,teacher_online_state,teacher_edit_state) " +
            "values(#{passWord},#{teacherNumber},#{teacherName},#{teacherSex},#{teacherAge},#{teacherPhonenumber},#{onlineState},#{editState})")
